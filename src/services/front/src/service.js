...
export const getJoinedFileFromHDFS = async () =>
  await axios.get(process.env.REACT_APP_HDFS_HOST + "/show-files?directory=joined_data", null, {});
...
export const getMatchedAFromHDFS = async () =>
  await axios.get(process.env.REACT_APP_HDFS_HOST + "/show-files?directory=cluster_a_matched_data", null, {});
